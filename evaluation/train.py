...
img_size = 8
num_channels = 6
train_path='trainingGames'
validation_path='validationGames'

# We shall load all the training and validation images and labels into memory using openCV and use that during training
data = dataset.read_train_sets(train_path, img_size, classes, validation_path)
...
def save(sess, epoch):
        ...
        builder = tf.saved_model.builder.SavedModelBuilder("/Users/thomas/Personal-Projects/chess/evaluation/pos-model" + str(epoch))
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples/batch_size) == 0:
            ...
            #saver.save(session, '/Users/thomas/Personal-Projects/chess/evaluation/eval-model')
            tf.saved_model.simple_save(session,
                        'eval-model' + str(epoch),
                        inputs={"x": x},
